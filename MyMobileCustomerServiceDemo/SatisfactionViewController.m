...
- (void)viewDidLoad {
    ...
    self.bgView.frame = CGRectMake(0, 0, kDeviceWidth, kDeviceHeight);
...
- (UIImageView*)headImage
{
    if (_headImage == nil) {
        ...
        _headImage.frame = CGRectMake((kDeviceWidth-50)/2, 20 + 64, 50.f, 50.f);
...
- (UILabel*)nickLabel
{
    if (_nickLabel == nil) {
        ...
        _nickLabel.frame = CGRectMake(0, CGRectGetMaxY(_headImage.frame) + kViewSpace, kDeviceWidth, 15.f);
...
- (UILabel*)textLabel
{
    if (_textLabel == nil) {
        ...
        _textLabel.frame = CGRectMake(0, CGRectGetMaxY(_nickLabel.frame) + kViewSpace, kDeviceWidth, 15.f);
...
- (CWStarRateView*)starRateView
{
    if (_starRateView == nil) {
        _starRateView = [[CWStarRateView alloc] initWithFrame:CGRectMake(10, CGRectGetMaxY(_textLabel.frame) + kViewSpace, kDeviceWidth - 20, 40) numberOfStars:5];
...
- (UITextView*)textView
{
    if (_textView == nil) {
        ...
        _textView.frame = CGRectMake(20, CGRectGetMaxY(_starRateView.frame) + kViewSpace, kDeviceWidth - 40, 100);
...
- (UIButton*)commitBtn
{
    if (_commitBtn == nil) {
        ...
        _commitBtn.frame = CGRectMake(20, CGRectGetMaxY(_textView.frame) + kViewSpace, kDeviceWidth - 40, 40);
        _commitBtn.layer.cornerRadius = 5.f;
        [_commitBtn setBackgroundColor:[UIColor colorWithRed:80/255.0 green:120/255.0 blue:200/255.0 alpha:1.0]];
